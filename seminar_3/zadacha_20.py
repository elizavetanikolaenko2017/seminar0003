...
rus = {1:'АВЕИНОРСТ',
      	...
      	8:'ШЭЮ',
      	10:'ФЩЪ'}
N = abs(int(input('Введите 1, если нужна  английская  раскладка, либо 0, если нужна русская: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('Данное слово -', sum([k for i in word for k, v in eng.items() if i in v]), 'очков')
elif N == 0:
	print('Данное слово -', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
else:
